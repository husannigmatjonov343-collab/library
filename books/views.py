...
def pages(request):
    ...
    return render(request, 'pages.html', {'articles': articles})
...
def pages(request):
    ...
    if category_id and category_id.isdigit():  # Agar raqam bo'lsa
    ...
    print(f"Kategoriya: {category_id}")
    print(f"Sort: {sort}")
    print(f"Maqolalar soni: {articles.count()}")
